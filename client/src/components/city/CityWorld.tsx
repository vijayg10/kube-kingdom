...
export function CityWorld() {
  ...
  return (
    <>
      ...
      <GroundCover positions={layout.props.groundCover.filter((_, i) => i % 3 === 0)} />
      ...
      <Merchant buildings={layout.buildings} districts={layout.districts} />
      ...
      <ResourceLabels buildings={layout.buildings} />
    </>
  );
}
